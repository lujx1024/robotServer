...
public class DBFunctionUtils {
	static Logger logger = Logger.getLogger(DBFunctionUtils.class.getName());
	...
	@Deprecated
	public static ViewEndpointLatestStatusId getEndPointById(String  epid) {
	...
	public static ViewEndpointLatestStatusId getEndPointByIdNt(String  epid) throws Throwable {
		// TODO Auto-generated method stub

		return 
		(ViewEndpointLatestStatusId) ViewUtils.getViewData(
		ViewUtils.dbProcQuery
		(ViewEndpointLatestStatus.class, "SP_GET_ENDPOINT_STATUS_BY_ENDPOINT_ID", epid));
	...
	public static void validateLoginSession(HttpServletRequest request) throws Throwable {
		...
		if (request != null ) {
			...
			logger.info(request.getSession().getAttribute(Admin.ADMIN));
	...
	public static List  getBindlistBySessionIdNt(String sessionId) throws Throwable {
		...
		return 
				...
				ViewUtils.dbProcQuery
				(ViewEndpointLatestStatus.class, "SP_GET_BIND_LIST_BY_SESSION_ID", sessionId));
	...
	public static ViewEndpointLatestStatusId getEndPointBySessionIdNt (
			String sessionId) throws Throwable {
		 
		return (ViewEndpointLatestStatusId) ViewUtils
				.getViewData(ViewUtils.dbProcQuery(
						ViewEndpointLatestStatus.class,
						"SP_GET_ENDPOINT_STATUS_BY_SESSION_ID", sessionId));
	}
	...
	public static List getUserRobotBindList(
		...
		return  ViewUtils.getViewDataList(
				ViewUtils.dbProcQuery(
						ViewUserRobotBindList.class, "SP_GET_USER_ROBOT_BIND_LIST_BY_SESSION_ID" , sessionId)
				);
