...
/**
 * ViewWordGroupFlowToVoiceGroupRuleOrignalId generated by hbm2java
 */
public class ViewWordGroupFlowToVoiceGroupRuleOrignalId implements
	...
	public ViewWordGroupFlowToVoiceGroupRuleOrignalId() {
	}

	public ViewWordGroupFlowToVoiceGroupRuleOrignalId(String request,
			...
			String description, long voiceGroupId, long voiceId,
			boolean voiceEnabled, long orignalRuleId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ViewWordGroupFlowToVoiceGroupRuleOrignalId))
			return false;
		ViewWordGroupFlowToVoiceGroupRuleOrignalId castOther = (ViewWordGroupFlowToVoiceGroupRuleOrignalId) other;
