...
/**
 * ViewRobotConfigForEditorMainId generated by hbm2java
 */
public class ViewRobotConfigForEditorMainId implements java.io.Serializable {
	...
	public ViewRobotConfigForEditorMainId() {
	}

	public ViewRobotConfigForEditorMainId(int priority, String robotImei,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ViewRobotConfigForEditorMainId))
			return false;
		ViewRobotConfigForEditorMainId castOther = (ViewRobotConfigForEditorMainId) other;
