...
/**
 * ViewConfigIndustryId generated by hbm2java
 */
public class ViewConfigIndustryId implements java.io.Serializable {
	...
	public ViewConfigIndustryId() {
	}

	public ViewConfigIndustryId(long ownerId, long ownerType, String ownerName,
			String name, String type, String value, long level,
			String description) {
	...
	public ViewConfigIndustryId(long ownerId, long ownerType, String ownerName,
			String name, String type, String value, long level, String limitL,
			String limitH, String candidate, String pattern, String description) {
		this.ownerId = ownerId;
		this.ownerType = ownerType;
		this.ownerName = ownerName;
		this.name = name;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ViewConfigIndustryId))
			return false;
		ViewConfigIndustryId castOther = (ViewConfigIndustryId) other;
