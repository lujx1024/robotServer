...
/**
 * ViewRobotMaxPriorityConfigId generated by hbm2java
 */
public class ViewRobotMaxPriorityConfigId implements java.io.Serializable {
	...
	public ViewRobotMaxPriorityConfigId() {
	}

	public ViewRobotMaxPriorityConfigId(int priority, String robotImei,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ViewRobotMaxPriorityConfigId))
			return false;
		ViewRobotMaxPriorityConfigId castOther = (ViewRobotMaxPriorityConfigId) other;
