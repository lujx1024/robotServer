...
/**
 * ViewConfigId generated by hbm2java
 */
public class ViewConfigId implements java.io.Serializable {
	...
	public ViewConfigId(String name, long ownerId, long ownerType, String type,
			String value, long level, String limitL, String limitH,
			String candidate, String pattern, String description) {
		this.name = name;
	...
	public ViewConfigId(String name, long ownerId, String ownerName,
			long ownerType, String ownerTypeName, String type, String value,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ViewConfigId))
			return false;
		ViewConfigId castOther = (ViewConfigId) other;
		...
		return ((this.getName() == castOther.getName()) || (this.getName() != null
				...
				&& ((this.getOwnerTypeName() == castOther.getOwnerTypeName()) || (this
						.getOwnerTypeName() != null
						&& castOther.getOwnerTypeName() != null && this
						.getOwnerTypeName()
						.equals(castOther.getOwnerTypeName())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getOwnerTypeName() == null ? 0 : this.getOwnerTypeName()
						.hashCode());
		result = 37 * result
